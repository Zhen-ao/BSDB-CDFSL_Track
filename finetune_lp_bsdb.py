...
def finetune(novel_loader, unl_loader, bathc_size, n_query=15, freeze_backbone=False, n_way=5, n_support=5):
    ...
    for _, (x, y) in enumerate(novel_loader):
        ...
        for epoch in range(total_epoch):
            ...
            for j in range(0, support_size, batch_size):
                ...
                output_db = pretrained_model(db_input)
                output = classifier(output)
                output_db = classifier(output_db)
        ...
        print('BSDB: %f' % (correct_ori / count_this * 100))
        ...
        print('BSDB+LP: %f' % (correct_lp / count_this * 100))
    ...
    print('BSDB: %d Test Acc = %4.2f%% +- %4.2f%%' %
    ...
    print('BSDB+LP: %d Test Acc = %4.2f%% +- %4.2f%%' %
